...
if (isset($_POST['submit'])) {
    ...
    if ($result) {
        ...
        $error = "Data insert is successfull.";
    ...
    <div class="hero min-h-screen bg-gray-200">
        <div class="hero-content flex flex-col ">
            <div class="text-center ">
                <h1 class="text-4xl font-bold">Look for tutors!</h1>
            </div>
                ...
                <div>
                    ...
                    <div id="loggedAsTeacher" class="tabcontent border-t py-2 px-4">
                        <form action="" class="card-body" method="post">
                            ...
                            <div class="form-control">
                                <label class="label">
                                    <span class="label-text">Per Week</span>
                                </label>
                                <input required name="weekly" type="number" placeholder="Per week" class="input input-bordered" />
                            </div>
                            <div class="form-control">
                                <label class="label">
                            ...
                            <div class="form-control">
                                <label class="label" for="type">
                                    <span class="label-text">Tuition Type</span>
                                </label>
